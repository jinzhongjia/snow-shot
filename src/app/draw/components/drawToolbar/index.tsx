...
import { AppSettingsData, AppSettingsGroup, CanHiddenToolSet } from '@/types/appSettings';
    ...
    useStateSubscriber(
        ...
        useCallback(
            (settings: AppSettingsData) => {
                ...
                setEnableSaveToCloud(settings[AppSettingsGroup.FunctionScreenshot].saveToCloud);
                // 不显示锁定绘制工具
